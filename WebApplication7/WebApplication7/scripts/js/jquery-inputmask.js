                ...
                for (f = j = b; i >= f; f++) {
                    ...
                    if (void 0 !== q)
                        for (var r = j, s = -1; r < D() && ((null == q.match.fn && l[f] && (l[f].match.optionalQuantifier === !0 || l[f].match.optionality === !0)) || null != q.match.fn); ) {
                            if (
                                (null === q.match.fn || (!g.keepStatic && l[f] && ((void 0 !== l[f + 1] && v(f + 1, l[f].locator.slice(), f).length > 1) || void 0 !== l[f].alternation)) ? r++ : (r = E(j)),
            ...
            for (n(!0), h = i + 1; h <= o(); ) {
                ...
                if ((i > h && (h = i + 1), (void 0 === m().validPositions[h] && C(h)) || void 0 !== l)) h++;
                    ...
                    k === !1 && j[i] && j[i].match.def === p.match.def
                        ? ((m().validPositions[i] = a.extend(!0, {}, j[i])), (m().validPositions[i].input = p.input), delete m().validPositions[h], h++)
                        : t(i, p.match.def)
                        ? B(i, p.input || I(h), !0) !== !1 && (delete m().validPositions[h], h++, (k = !0))
                        : C(h) || (h++, i--),
                        i++;
                }
            }
        ...
        function B(c, d, e, f) {
            ...
            for (w++; l > w; w++)
                void 0 === m().validPositions[w] &&
                    ...
                    i(o(w, !0) + 1, F.match.placeholder || (null == F.match.fn ? F.match.def : "" !== I(w) ? I(w) : x()[w]), !0, f);
                    ...
                    if (d.length > 2)
                        for (var f = 0; f < d.length; f++)
                            if (
                                ...
                                (e.push(d[f]), null === d[f].match.fn && (c = d[f]), e.length > 1)
                            )
                            ...
                            if (
                                ...
                                if (
                                    (null !== f.min && isFinite(f.min) && l < parseFloat(f.min)
                                        ...
                                        : null !== f.max && isFinite(f.max) && l > parseFloat(f.max) && ((k = Math.abs(f.max)), (j = f.max < 0), (h = void 0)),
                        ...
                        if (!e)
                            if (f.numericInput === !0) {
                                var h = c.buffer.slice("").reverse(),
                                    i = h[f.prefix.length];
                                if ("0" === i && void 0 === c.validPositions[d - 1]) return { pos: d, remove: h.length - f.prefix.length - 1 };
                            } else {
                                ...
                                if (k && (-1 === j || j >= d)) {
                                    ...
                                    if (0 === k[0].indexOf("" !== f.placeholder ? f.placeholder.charAt(0) : "0") && (k.index + 1 === d || (g !== !0 && 0 === l))) return c.buffer.splice(k.index, 1), { pos: k.index, remove: k.index };
                        ...
                        "~": {
                            validator: function (c, d, e, f, g, h) {
                                ...
                                if (
                                    ...
                                    i =
                                        -1 !== j && (g.digitsOptional === !1 || d.validPositions[e]) && g.numericInput !== !0 && e > j && !f
                                            ? {
                                                  pos: e,
                                                  remove: e,
                                              }
